...
public class GalleryTests extends ApplicationTest {
    ...
    public void start(Stage stage) {
        ...
        galleryController.backButton = new Button();
        galleryController.forwardButton = new Button();
        ...
        // Set up the stage for JavaFX (you can leave it empty if no UI is displayed)
        stage.show();
    }

    @BeforeEach
    public void setUp() throws Exception {
        FxToolkit.registerPrimaryStage(); // Register the primary stage
    }
